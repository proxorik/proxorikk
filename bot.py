...
def start_command(message):
    ...
    bot.send_message(
        ...
        f"Я очень рад общаться с тобой! 🎉 Просто отправь мне сообщение, и я отвечу осмысленным ответом. Я здесь, чтобы помогать, развлекать или просто обсуждать твой день! 💬\n\n"
